...
export const Service = () => (
  <div className="position-relative border text-center m-auto my-4 mx-auto w-75">
      ...
      <ListGroup as="ul" className="w-100">
        ...
        >
          ...
          <span className="lh-1 text-start w-50">
            Este es un texto con ciertas caracteristicas que no puedo mensionar
            gustele a quien le guste.
          </span>
          <span className="p- col-1">Valor</span>
          <span className="p-2 col-2">Tiempo</span>
          <Nav.Link href="/home">
        ...
        >
          <img src="https://placehold.co/50x25" className="rounded" />
          <span className="lh-1 text-start w-50">Servicio.</span>
          <span className="p- col-1">Valor</span>
          <span className="p-2 col-2">Tiempo</span>
          <Nav.Link href="/home">
            <i className="bi bi-pencil-fill"></i>
